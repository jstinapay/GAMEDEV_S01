...
namespace GummiShip
{
    ...
    public static class VesperTemplate
    {
        ...
        public static GummiShip Build(string shipName, bool recordUndo)
        {
            ...
            B(ship, GummiBlockType.EngineHousing, -1.6f, 0f, -5f, 1.2f, 1.2f, 2.5f, "Port_Engine", recordUndo);
            B(ship, GummiBlockType.EngineHousing, 1.6f, 0f, -5f, 1.2f, 1.2f, 2.5f, "Stbd_Engine", recordUndo);
            B(ship, GummiBlockType.EngineNozzle, -1.6f, 0f, -6.4f, 1f, 1f, 0.5f, "Port_EngineNozzle", recordUndo);
            B(ship, GummiBlockType.EngineNozzle, 1.6f, 0f, -6.4f, 1f, 1f, 0.5f, "Stbd_EngineNozzle", recordUndo);

            // ---- Phase 5: stepped-sweep wings + tip fins ----
            B(ship, GummiBlockType.WingPanel, -2f, -0.1f, -1.2f, 2.4f, 0.25f, 2.4f, "Port_WingInner", recordUndo);
            B(ship, GummiBlockType.WingPanel, 2f, -0.1f, -1.2f, 2.4f, 0.25f, 2.4f, "Stbd_WingInner", recordUndo);
            B(ship, GummiBlockType.WingPanel, -3.8f, -0.1f, -2f, 1.8f, 0.25f, 1.8f, "Port_WingOuter", recordUndo);
            B(ship, GummiBlockType.WingPanel, 3.8f, -0.1f, -2f, 1.8f, 0.25f, 1.8f, "Stbd_WingOuter", recordUndo);
            B(ship, GummiBlockType.TipFin, -4.65f, 0.55f, -2.4f, 0.25f, 1.5f, 1.6f, "Port_TipFin", recordUndo);
            B(ship, GummiBlockType.TipFin, 4.65f, 0.55f, -2.4f, 0.25f, 1.5f, 1.6f, "Stbd_TipFin", recordUndo);

            // ---- Phase 6: weapons (small, secondary on a surveyor) ----
            B(ship, GummiBlockType.RepeaterGun, -1.9f, -0.3f, 0.8f, 0.4f, 0.4f, 1.8f, "Port_Repeater", recordUndo);
            B(ship, GummiBlockType.RepeaterGun, 1.9f, -0.3f, 0.8f, 0.4f, 0.4f, 1.8f, "Stbd_Repeater", recordUndo);
            ...
            // ---- Phase 7a: defense ----
            B(ship, GummiBlockType.ShieldBlister, -1.75f, 0.15f, -0.5f, 0.9f, 0.7f, 1.2f, "Port_ShieldBlister", recordUndo);
            B(ship, GummiBlockType.ShieldBlister, 1.75f, 0.15f, -0.5f, 0.9f, 0.7f, 1.2f, "Stbd_ShieldBlister", recordUndo);
            B(ship, GummiBlockType.ShieldProjector, 0f, 0.55f, -5f, 0.8f, 0.8f, 0.6f, "Aft_ShieldProjector", recordUndo);
            ...
            B(ship, GummiBlockType.FuelDrum, -1.75f, 0.05f, -3.4f, 1.1f, 1.1f, 2.6f, "Port_FuelDrum", recordUndo);
            B(ship, GummiBlockType.FuelDrum, 1.75f, 0.05f, -3.4f, 1.1f, 1.1f, 2.6f, "Stbd_FuelDrum", recordUndo);
            B(ship, GummiBlockType.DrumStrap, -1.75f, 0.05f, -2.7f, 1.25f, 1.25f, 0.3f, "Port_DrumStrap_Fwd", recordUndo);
            B(ship, GummiBlockType.DrumStrap, -1.75f, 0.05f, -4.1f, 1.25f, 1.25f, 0.3f, "Port_DrumStrap_Aft", recordUndo);
            B(ship, GummiBlockType.DrumStrap, 1.75f, 0.05f, -2.7f, 1.25f, 1.25f, 0.3f, "Stbd_DrumStrap_Fwd", recordUndo);
            B(ship, GummiBlockType.DrumStrap, 1.75f, 0.05f, -4.1f, 1.25f, 1.25f, 0.3f, "Stbd_DrumStrap_Aft", recordUndo);
            ...
            B(ship, GummiBlockType.RCSBlock, -4.65f, 0.5f, -1.5f, 0.3f, 0.3f, 0.3f, "RCS_PortTip", recordUndo);
            B(ship, GummiBlockType.RCSBlock, 4.65f, 0.5f, -1.5f, 0.3f, 0.3f, 0.3f, "RCS_StbdTip", recordUndo);
            // Nav beacons: red port, green starboard, set into the tip fins.
            B(ship, GummiBlockType.BeaconRed, -4.65f, 0f, -3.1f, 0.35f, 0.35f, 0.35f, "Port_NavLight", recordUndo);
            B(ship, GummiBlockType.BeaconGreen, 4.65f, 0f, -3.1f, 0.35f, 0.35f, 0.35f, "Stbd_NavLight", recordUndo);
